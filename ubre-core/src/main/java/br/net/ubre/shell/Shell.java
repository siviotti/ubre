...
import br.net.ubre.shell.command.DebugCmd;
import br.net.ubre.shell.command.DumpCmd;
import br.net.ubre.shell.command.HelpCmd;
import br.net.ubre.shell.command.ImportCmd;
import br.net.ubre.shell.command.ScriptCmd;
import br.net.ubre.shell.command.ShellCommand;
