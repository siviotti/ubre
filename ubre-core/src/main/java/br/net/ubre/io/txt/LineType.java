...
import br.net.ubre.io.txt.converter.DomainConverter;
import br.net.ubre.io.txt.converter.DomainItemConverter;
import br.net.ubre.io.txt.converter.DomainMetaConverter;
import br.net.ubre.io.txt.converter.EventConverter;
import br.net.ubre.io.txt.converter.LineConverter;
import br.net.ubre.io.txt.converter.MessageConverter;
import br.net.ubre.io.txt.converter.MetadataConverter;
import br.net.ubre.io.txt.converter.ProcessConverter;
import br.net.ubre.io.txt.converter.ScopeConverter;
import br.net.ubre.io.txt.converter.VarConverter;
import br.net.ubre.io.txt.converter.rule.RuleConverter;
