...
public class ProcessConverter extends LineConverter {
	...
	@Override
	public br.gov.serpro.ubre.framework.process.Process asObject(Context context,
			Line line) {
		...
		br.gov.serpro.ubre.framework.process.Process parent = null;
		...
		br.gov.serpro.ubre.framework.process.Process process = new br.gov.serpro.ubre.framework.process.Process(
	...
	public Line asLine(ContextElement parent, Object object) {
		br.gov.serpro.ubre.framework.process.Process process = (Process) object;
	...
	private void validateParent(br.gov.serpro.ubre.framework.process.Process parent,
