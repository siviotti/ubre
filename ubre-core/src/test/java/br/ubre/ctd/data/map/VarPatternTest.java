package br.ubre.ctd.data.map;

import static br.net.ubre.data.map.VarPattern.TOKEN_PATTERN_MSG_FISRT_CHAR;
import static br.net.ubre.data.map.VarPattern.TOKEN_PATTERN_MSG_INVALID_BEGIN;
import static br.net.ubre.data.map.VarPattern.TOKEN_PATTERN_MSG_INVALID_CHAR;
import static br.net.ubre.data.map.VarPattern.TOKEN_PATTERN_MSG_MAX_SIZE;
import static br.net.ubre.data.map.VarPattern.TOKEN_PATTERN_MSG_NULL_OR_EMPTY;
